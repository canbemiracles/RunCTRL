<template>
    <div class="container-fluid p-0 d-flex flex-column">
        ...
        <div class="page-container d-flex">
            <router-view :currentSlide="currentSlide" 
            @reInitScroll="reInitScroll"
            @onScroll="offScrollEventListener" @offScroll="onScrollEventListener"></router-view> 
            <side-nav @moveTo="moveSlide" :current="currentSlide" :bullets="total"></side-nav>
        </div>
    </div>
</template>
<script>
...
export default {
    ...
    components: {
        ...
        sideNav: require('../SidebarRecommend/SidebarNav'),
    }
}
</script>
