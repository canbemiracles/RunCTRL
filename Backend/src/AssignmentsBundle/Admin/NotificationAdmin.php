...
class NotificationAdmin  extends AbstractAdmin
{
    protected function configureFormFields(FormMapper $formMapper)
    {
        ...
        $formMapper->add('title', 'text', ['label' => 'Title for this assignment:'])
            ->add('description', 'text', ['label' => 'Description for notification:'])
            ->add('role', EntityType::class, [
                'class' => BranchStationOriginRole::class,
                'choice_label' => function ($role) {
                    /** @var $role AbstractBranchStationRole*/
                    return 'Branch address: '.$role->getBranchStation()->getBranch()->getGeographicalArea()->getCountry()->getName().', '
                        . $role->getBranchStation()->getBranch()->getGeographicalArea()->getCity().', '.$role->getBranchStation()->getBranch()->getGeographicalArea()->getStreetAddress()
